from sqlalchemy import Boolean, DateTime, Enum, Integer, String, Text, Numeric, Float
...
def test_model_structure_column_constraints(db_inspector):
    ...
    assert any(constraint["name"] == "product_order_line_range" for constraint in constraints)
